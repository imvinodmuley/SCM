...
//                3,product_id,product_name,manufaturing_date
            ...
            case 8:
            {
                String login_url = "http://" + ip_addr + "/mobdapp/nodejs/addproduct.php";
                ...
                try {
                    ...
                    OutputStream outputStream = httpURLConnection.getOutputStream();
                    BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                    String post_data = URLEncoder.encode("customermobileno","UTF-8")+"="+URLEncoder.encode(username,"UTF-8");
                    //+URLEncoder.encode("tid","UTF-8")+"="+URLEncoder.encode(tid,"UTF-8");
                    bufferedWriter.write(post_data);
                    bufferedWriter.flush();
                    bufferedWriter.close();
            ...
            case 9:
            {
                String login_url = "http://" + ip_addr + "/mobdapp/nodejs/scanshipment.php";
            ...
            case 10: {
                ...
                String login_url = "http://" + ip_addr + "/dapp/getfinecount.php";
                try {
                    String customermob = strings[1];
                    URL url = new URL(login_url);
                    HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
                    httpURLConnection.setRequestMethod("POST");
                    httpURLConnection.setDoOutput(true);
                    ...
                    OutputStream outputStream = httpURLConnection.getOutputStream();
                    BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                    String post_data = URLEncoder.encode("customermob", "UTF-8") + "=" + URLEncoder.encode(customermob, "UTF-8") ;
                    bufferedWriter.write(post_data);
                    bufferedWriter.flush();
                    bufferedWriter.close();
                    outputStream.close();
            ...
            case 11: {
                ...
                String login_url = "http://" + ip_addr + "/dapp/getrewardcount.php";
                try {
                    String customermob = strings[1];
            ...
            case 12: {
                ...
                String login_url = "http://" + ip_addr + "/dapp/setamount.php";
                try {
                    String customermob = strings[1];
                    String amount=strings[2];
                    String direction= strings[3];
                    ...
                    OutputStream outputStream = httpURLConnection.getOutputStream();
                    BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                    String post_data = URLEncoder.encode("cutomermob", "UTF-8") + "=" + URLEncoder.encode(customermob, "UTF-8") + "&"
...
//        }
        ...
        }else if (resulti.contains("product_id"))
        {
            ...
            toast.show();
        }else if(resulti.contains("reward"))
        {
            context.startActivity(new Intent(context,rewardfine.class));
        }
    }
}
